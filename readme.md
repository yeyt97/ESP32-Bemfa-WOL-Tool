...
<img src="imgs/topic.png" width=50%>
...
1. 参考官方 API https://cloud.bemfa.com/docs/src/api_device.html

   在 postman 中发送 HTTP 请求调用

   <img src="imgs/postman.png" width=50%>

2. 发送后 ESP32 上的灯会闪两下，表示调用成功。
3. 测试用过后可以通过苹果的快捷指令调用。

   <img src="imgs/shortcuts.png" width=25%>

#### 米家

1. 在米家 app 中添加巴法云，参考：https://cloud.bemfa.com/docs/src/speaker_mi.html
2. 米家：对小爱音箱说：打开电脑开关(你自己设置的 topic 昵称)。这时 ESP32 上的 LED 会闪两下，电脑就启动了。
3. 然后可以在米家的智能里创建一个手动控制，设置小爱音箱的自定义指令，发送”打开电脑开关“，这样就能在米家 app 里点击就能启动电脑了，不需要喊小爱音箱。

<img src="imgs/mihome.png" width=25%>

<img src="imgs/mihome2.png" width=25%>
